...
class AcrobotEnv(BaseEnv):
    """4-D acrobot environment.

    State: ``[q1, q2, q1_dot, q2_dot]``, control: torque on joint 2.
    Joint angles (dimensions 0 and 1) wrap to ``(-pi, pi]``.

    Args:
        num_envs: Number of parallel environments.
        dynamics_fn: Override dynamics (default: ``acrobot_dynamics``).
        max_torque: Symmetric torque bound on joint 2.
