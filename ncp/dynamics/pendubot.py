"""Pendubot dynamics (torque on first joint only)."""
...
def pendubot_dynamics(
    ...
    *,
    ...
    """Batched pendubot dynamics (torque on joint 1 only).

    Same mass-matrix as the acrobot but with ``B = [1; 0]``.

    Args:
        x: States of shape ``(B, 4)`` — ``[q1, q2, q1_dot, q2_dot]``.
        u: Controls of shape ``(B,)`` or ``(B, 1)`` — torque on joint 1.
        m1: Mass of link 1.
        m2: Mass of link 2.
        l1: Length of link 1.
        l2: Length of link 2.
