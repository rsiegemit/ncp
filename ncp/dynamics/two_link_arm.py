"""Fully-actuated 2-link robot arm dynamics."""
...
def two_link_arm_dynamics(
    ...
    *,
    ...
    """Batched 2-link robot arm dynamics (fully actuated).

    Same mass-matrix as the acrobot but with ``B = I(2x2)``.

    Args:
        x: States of shape ``(B, 4)`` — ``[q1, q2, q1_dot, q2_dot]``.
        u: Controls of shape ``(B, 2)`` — ``[tau1, tau2]``.
        m1: Mass of link 1.
        m2: Mass of link 2.
        l1: Length of link 1.
        l2: Length of link 2.
