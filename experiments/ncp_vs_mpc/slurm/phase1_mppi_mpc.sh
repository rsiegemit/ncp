...
#SBATCH --array=0-14
#SBATCH --output=/n/home02/rsiegelmann/experiments/ncp_vs_mpc/logs/phase1/mppi_%a_%j.log
...
echo "Phase 1 MPPI-MPC: task ${SLURM_ARRAY_TASK_ID}, node ${SLURM_NODELIST}"
which python
nvidia-smi
...
python src/run_mppi_mpc.py --index ${SLURM_ARRAY_TASK_ID} --phase 1
