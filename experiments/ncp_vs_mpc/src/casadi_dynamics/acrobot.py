"""CasADi symbolic dynamics for Acrobot."""
import casadi as ca


def acrobot_casadi(m1=1.0, m2=1.0, l1=1.0, l2=1.0, lc1=0.5, lc2=0.5, I1=1.0, I2=1.0, g=9.81):
    """Return (x, u, xdot) CasADi MX symbolics for Acrobot.

    State: [q1, q2, q1_dot, q2_dot], Control: [torque_joint2]
    """
    x = ca.MX.sym("x", 4)
    u = ca.MX.sym("u", 1)
